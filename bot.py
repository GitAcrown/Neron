...
logger = logging.getLogger('Neron.Main') # Le nom de base dans les loggers des modules sont à modifier selon le nom du bot
...
async def main():
    bot = commands.Bot(
       command_prefix="n!", # Prefix du bot 
        description="Bot multifonction modulaire français", # Description du bot
        help_command=None,
        intents=intents,
    )
